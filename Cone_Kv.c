...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv_cone Cone_Kv.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = mKv_columnindex;  _dlist1[0] = DmKv_columnindex;
 _slist1[1] = hKv_columnindex;  _dlist1[1] = DhKv_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Cone_Kv.mod";
static const char* nmodl_file_text = 
